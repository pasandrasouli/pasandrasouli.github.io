...
export const medicineReminder: Project = {
  ...
  caseStudy: [
    ...
    { type: "image", caption: "Information Architecture (IA):", src: "https://placehold.co/600x400/EEE/31343C" },
    { type: "image", caption: "Wireframes (Low Fidelity):", src: "https://placehold.co/600x400/EEE/31343C" },
    { type: "image", caption: "Visual Design (Mid-Fidelity):", src: "https://placehold.co/600x400/EEE/31343C" },
    ...
    },
    {
      ...
      titleGroups: [{ subTitle: "Goal", description: "To collect numerical data that evaluates the performance of the design and identifies high-level issues" }],
      items: [
        'Task-Based Testing:',
    ...
    },
    {
      type: "withBullet",
      title: "Quantitative Testing",
      titleGroups: [{ subTitle: "Goal", description: "To understand user experiences, uncover deeper issues, and gather feedback for improving the design" }],
      items: [
    ...
    },
     {
      type: "section",
      title: "Outcome",
      description: "Qualitative insights that identify deeper issues and improve user interactions with the system."
    },
  ]
}
