    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
      <div class="flex items-end justify-between mb-14 flex-wrap gap-6">
        <div>
          ...
          <h2 class="text-4xl md:text-6xl font-semibold tracking-tight mb-4">
            {{ content.title }}
          </h2>
        ...
        >
          <div class="overflow-hidden">
            <img
              ...
              :alt="project.title"
              class="work-thumbnail w-full h-[280px] object-cover"
            />
          </div>
          <div class="p-8">
            <div class="flex items-center justify-between">
              ...
              <div
                class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:bg-white/10 transition"
              >
                ↗
              </div>
            </div>
